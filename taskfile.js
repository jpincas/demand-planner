...
export async function copySampleData(taskr, o) {
  await taskr.source(o.src || src.sampleData).target(target)
}
...
export async function build(taskr) {
  // TODO add linting
  await taskr.serial(['clean', 'copyStaticAssets', 'copySampleData', 'styles', 'js', 'vendors'])
}
